...
\cite{gom} \todo[inline]{[[OTHER REFERENCES]]} The technical development in this paper can be generalised to such
...
The characterisation of $\Trees(X)$ below is standard, cf.\
